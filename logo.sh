...
echo -e "${BOLD}${CYAN}    ____  _____ ___  _______________    __  ___   "
echo -e "${BOLD}${CYAN}   / __ \/ ___//   |/_  __/ ____/   |  /  |/  /   "
echo -e "${BOLD}${CYAN}  / / / /\__ \/ /| | / / / __/ / /| | / /|_/ /    " 
echo -e "${BOLD}${CYAN} / /_/ /___/ / ___ |/ / / /___/ ___ |/ /  / /     "
echo -e "${BOLD}${CYAN} \____//____/_/  |_/_/ /_____/_/  |_/_/  /_/      "
echo -e "                                                  \n"
