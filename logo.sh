...
echo -e "${BOLD}${CYAN}${BGMAGENTA}    ____  _____ ___  _______________    __  ___   "
echo -e "${BOLD}${CYAN}${BGMAGENTA}   / __ \/ ___//   |/_  __/ ____/   |  /  |/  /   "
echo -e "${BOLD}${CYAN}${BGMAGENTA}  / / / /\__ \/ /| | / / / __/ / /| | / /|_/ /    " 
echo -e "${BOLD}${CYAN}${BGMAGENTA} / /_/ /___/ / ___ |/ / / /___/ ___ |/ /  / /     "
echo -e "${BOLD}${CYAN}${BGMAGENTA} \____//____/_/  |_/_/ /_____/_/  |_/_/  /_/      "
echo -e "                                                  \n"
